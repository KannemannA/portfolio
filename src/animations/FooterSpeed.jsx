...
const Hyperspeed = ({ effectOptions = {
  ...
  useEffect(() => {
    ...
    (function () {
      ...
      myApp = new App(container, effectOptions);
    ...
    return () => {
      if (myApp) {
        myApp.dispose();
        myApp.renderer.dispose();
        myApp.composer.dispose();
        myApp.scene.children.forEach(child => {
        ...
        myApp.container.removeChild(myApp.renderer.domElement);
  
        window.removeEventListener("resize", myApp.onWindowResize);
        myApp.container.removeEventListener("mousedown", myApp.onMouseDown);
        myApp.container.removeEventListener("mouseup", myApp.onMouseUp);
        myApp.container.removeEventListener("mouseout", myApp.onMouseUp);
        myApp.container.removeEventListener("touchstart", myApp.onMouseDown);
        myApp.container.removeEventListener("touchend", myApp.onMouseUp);
        myApp.container.removeEventListener("touchcancel", myApp.onMouseUp);
      }
    };
  }, [isVisible]);
